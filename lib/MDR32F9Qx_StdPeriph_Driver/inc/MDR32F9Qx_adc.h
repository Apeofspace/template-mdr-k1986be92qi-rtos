...
typedef enum
{
    ...
    #define ADC_SAMPLING_MODE_CICLIC_CONV ADC_SAMPLING_MODE_CYCLIC_CONV
    #warning "Legacy v1.5.3: ADC_SAMPLING_MODE_CICLIC_CONV will be removed and replaced with ADC_SAMPLING_MODE_CYCLIC_CONV"
...
typedef struct {
    ...
    uint32_t                   ADC_StartDelay;           /*!< Specifies the ADC1 and ADC2 conversion start delay.
                                                              This parameter can be a number between 0 and 15. For MDR1901VC1 and MDR1986VE9x only. */
#endif /* #if defined (USE_MDR1986VE9x) || defined (USE_MDR1901VC1T) */
    ...
    uint32_t                   ADC_IntVRefTrimming;      /*!< Configures the internal voltage reference trimming. @ref ADC_Int_VRef_Trimming
                                                              This parameter can be a number between 0 and 7 for MDR1986VE9x and MDR1901VC1T;
                                                                                and a number between 0 and 31 for MDR1986VE3 and MDR1986VE1T */
#if defined (USE_MDR1986VE1T) || defined (USE_MDR1986VE3)
