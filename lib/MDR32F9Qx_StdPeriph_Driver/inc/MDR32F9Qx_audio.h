...
/** @addtogroup AUDIO_IP
  * @warning This module can be used only for MDR1986VE3 and MDR1901VC1T microcontroller's.
  * @{
  */
...
void AUDIO_IP_SetADCInputAmplifierLevel(AUDIO_IP_ADC_Input_Ampl InputAmplifierLevel);
    ...
    #warning "Legacy v1.5.3: AUDIO_IP_SetADCInputAdmplifierLevel() will be removed and replaced with AUDIO_IP_SetADCInputAmplifierLevel()"
    #define AUDIO_IP_SetADCInputAdmplifierLevel(InpAmpLvl) AUDIO_IP_SetADCInputAmplifierLevel(InpAmpLvl)
