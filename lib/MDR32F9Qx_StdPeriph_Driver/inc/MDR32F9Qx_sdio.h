...
/** @addtogroup SDIO
  * @warning This module can be used only for MDR1901VC1 microcontroller's.
  * @{
  */
...
/** @defgroup SDIO_FLAG SDIO_FLAG
  ...
  */
    ...
    #warning "Legacy v1.5.3: SDIO_FLAG_CMD_TRANSFER_ACIVE and SDIO_FLAG_DATA_TRANSFER_ACIVE will be removed and replaced with SDIO_FLAG_CMD_TRANSFER_ACTIVE and SDIO_FLAG_DATA_TRANSFER_ACTIVE"
