/**
  ...
  * @version V2.0.0
  * @date    06/05/2021
  * @brief   This file contains all the functions prototypes for the USB device
  *          firmware library.
  ******************************************************************************
  * <br><br>
  *
...
typedef enum
{
    USB_SUCCESS     = 0x0000, /*!< Success. */
    USB_ERROR       = 0x0001, /*!< General USB driver failure. */
    USB_ERR_INV_REQ = 0x0002, /*!< Incorrect data in USB device request. */
    USB_ERR_BUSY    = 0x0200, /*!< Action cannot be proceeded at this time. */
} USB_Result;
