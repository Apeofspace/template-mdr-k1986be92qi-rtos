...
#define IS_MIL_STD_1553_DEVIDER(DIVIDER)    ((DIVIDER) <= 0x78)
...
typedef struct
{
    ...
    /**
     * @note This members may be used only for MDR1986VE1T rev. 3 and 4, and for MDR1986VE3T rev. 2.
     */
    ...
    /**
     * @note This members may be used only for MDR1986VE1T rev. 6 and later, and for MDR1986VE3T rev. 3 and later.
     */
...
typedef union
{
    ...
    #warning "Legacy v1.5.3: Bool enumeration will be removed as not used"
/**
...
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: MIL_STD_1553_StartTransmision() will be removed and replaced with MIL_STD_1553_StartTransmission()"
    #define MIL_STD_1553_StartTransmision(MIL_STD_1553x) MIL_STD_1553_StartTransmission(MIL_STD_1553x)
#endif /* MDR_LEGACY_SUPPORT 153 */
...
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: MIL_STD_1553_WiteDataToSendBuffer() will be removed and replaced with MIL_STD_1553_WriteDataToSendBuffer()"
    #define MIL_STD_1553_WiteDataToSendBuffer(MIL_STD_1553x, Subaddress, NumberDataWords, ptr_Src) MIL_STD_1553_WriteDataToSendBuffer(MIL_STD_1553x, Subaddress, NumberDataWords, ptr_Src)
#endif /* MDR_LEGACY_SUPPORT 153 */
