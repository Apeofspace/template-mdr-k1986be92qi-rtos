...
/** @defgroup UART_Exported_Types UART Exported Types
  ...
  */
    ...
    #warning "Legacy v1.5.3: BaudRateStatus enumeration is deprecated. Use @ref ErrorStatus instead"
/**
  * @brief UART Baud rate status
  */
typedef enum
{
    BaudRateInvalid = 0,
    BaudRateValid = !BaudRateInvalid
} BaudRateStatus;
...
#define IS_UART_CONFIG_ITS(IT)  (((IT) <= 0x07FF)
