...
typedef struct
{
    ...
    #warning "Legacy v1.5.3: @ref BitAction enumeration (Bit_RESET, Bit_SET) will be removed. Use @ref BitStatus."
/**
  * @brief   Bit_SET and Bit_RESET enumeration
  * @warning Deprecared, use @ref BitStatus instead.
  */
typedef enum
{
    Bit_RESET = 0,
...
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: BitAction enumeration (Bit_RESET, Bit_SET) will be removed. In PORT_WriteBit() function use @ref BitStatus instead of @ref BitAction"
