...
void RST_CLK_WarmDeInit(void)
{
    ...
    MDR_RST_CLK->UART_SSP_CLOCK &= (uint32_t)0x00000000;
...
/**
  ...
  *                RST_CLK_PCLK_PORTA,   RST_CLK_PCLK_PORTB,  RST_CLK_PCLK_PORTC,
  *                RST_CLK_PCLK_PORTD,   RST_CLK_PCLK_PORTE,  RST_CLK_PCLK_PORTF.
  *           @note for MDR1986VE1T and MDR1986VE3:
  *           @arg RST_CLK_PCLK_RST_CLK,       RST_CLK_PCLK_EEPROM, RST_CLK_PCLK_DMA,
  *                RST_CLK_PCLK_CAN1,          RST_CLK_PCLK_CAN2,
...
#if defined (USE_MDR1986VE3)
/**
  * @brief   Enables or disables the PER2_CLOCK bits.
  ...
  *          This parameter can be any combination of the following values:
  *          @arg RST_CLK_PCLK2_AUDIO_IP, RST_CLK_PCLK2_LED,   RST_CLK_PCLK2_KEYBOARD,
  *               RST_CLK_PCLK2_UART3,    RST_CLK_PCLK2_UART4, RST_CLK_PCLK2_SSP4,
  *               RST_CLK_PCLK2_PORTG,    RST_CLK_PCLK2_PORTH, RST_CLK_PCLK2_PORTI
  * @param  NewState - @ref FunctionalState - new state of the specified peripheral clock.
  * @retval None
  */
...
/**
  ...
  * @warning This function can be used only for microcontrollers MDR1986VE3 and MDR1901VC1T.
  * @param   None.
  * @retval  None.
  */
...
#endif /* #if defined (USE_MDR1986VE3) || defined (USE_MDR1901VC1T) */
...
/**
  ...
  * @warning This function can be used only for microcontroller MDR1901VC1T.
