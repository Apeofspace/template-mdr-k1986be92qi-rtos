/**
  ...
  * @version V2.0.0
  * @date    06/05/2021
  * @brief   This file contains all the LED Display firmware functions.
  ******************************************************************************
  * <br><br>
  *
...
/**
  * @brief  Initializes the LED peripheral clock according to the specified parameters.
  * @param  LED_BRG_Value - @ref LED_BRG - specifies the HCLK division factor.
  * @retval None.
  */
void LED_BRGInit(LED_BRG LED_BRG_Value)
{
    ...
    assert_param(IS_LED_BRG(LED_BRG_Value));

    tmperg = MDR_LED->DivR & (~LED_DIVR_DIV_Msk);
    tmperg |= ((uint32_t)LED_BRG_Value) << LED_DIVR_DIV_Pos;
...
/**
  ...
  * @param  LED_InitStruct: pointer to a @ref LED_InitTypeDef structure
...
/**
  ...
  * @param  NewState - @ref FunctionalState - new state of the LED peripheral.
  * @retval None.
  */
...
/**
  ...
  * @param  output - @ref LED_Inversion_Output - defines the specified field.
  * @param  NewState - @ref FunctionalState - new state of the output inversion.
  * @retval None.
  */
...
/**
  ...
  * @param  NewState - @ref FunctionalState - new state of the LED interrupt.
  * @retval None.
  */
...
/**
  ...
  * @param  NewState - @ref FunctionalState - new state of the display flicker.
  * @retval None.
  */
...
/**
  * @brief  Checks the value of the flag display controller readyfor recording data.
  * @param  None.
  * @retval @FlagStatus - the current state of the ready flag.
  */
...
/**
  ...
  * @param  led_frame - @ref LED_Frame_Number - the number of the cleared frame.
  * @retval None.
  */
void LED_ClearFrame(LED_Frame_Number led_frame)
{
    ...
    for(i = 0; i < 64; i++)
    {
        MDR_LED->TextBuf[(uint32_t)led_frame * 64 + i] = 0;
    }
}
