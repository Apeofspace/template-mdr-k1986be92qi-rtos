/**
  ******************************************************************************
  * @file    MDR32F9Qx_usb_CDC.c
  * @author  Milandr Application Team
  * @version V2.0.0
  * @date    09/04/2021
  * @brief   This file contains all the USB CDC firmware functions.
  ******************************************************************************
  * <br><br>
  *
...
/**
  ...
  *         be set to 1.
  * @param  StartReceiving - @ref FlagStatus - Flag indicating whether
  *         the device will accept incoming data immediately after
  *         USB_CDC_Reset is called for the first time.
...
/**
  ...
  * @param  Buffer: Pointer to the user's buffer with portion of data sent
...
/**
  ...
  * @retval @ref USB_Result. If USB_SUCCESS is returned, the device continues
...
/**
  ...
  * @param  wINDEX: Interface number
  * @param  DATA: Pointer to @ref USB_CDC_LineCoding_TypeDef structure that
...
/**
  ...
  * @param  wINDEX: Interface number
  * @param  DATA: Pointer to @ref USB_CDC_LineCoding_TypeDef structure
